...
writeRaster(mask_offset_45,"data/genomic_data/offset_4.5_beagle.tif", format="GTiff", overwrite=TRUE)
writeRaster(mask_offset_85,"data/genomic_data/offset_8.5_beagle.tif", format="GTiff", overwrite=TRUE)
