...
env1_peakbf2 <- read_csv("data/genomic_data/win_bf_mat30_5.csv")
env2_peakbf2 <- read_csv("data/genomic_data/win_bf_map30_5.csv")
env5_peakbf2 <- read_csv("data/genomic_data/win_bf_cmd30_5.csv")
