...
snp_clim_bf20NA <- read_csv("data/genomic_data/env9only_snp_set.csv") #pop data
...
writeRaster(mask_offset_2012,"data/genomic_data/offset_env9.tif", format="GTiff", overwrite=TRUE)
