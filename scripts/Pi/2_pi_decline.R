...
#stats
lm1 <- lm(lambda.slope.trunc~pi_snp_set,data=pi_pop)
lm2 <- lm(lambda.slope.trunc~pi_all_snps,data=pi_pop)
lm3 <- lm(lambda.mean~pi_snp_set,data=pi_pop)
lm4 <- lm(lambda.mean~pi_all_snps,data=pi_pop)
