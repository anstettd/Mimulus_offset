...
lm.SSP245 <- lm(Lambda_slope~offset_SSP245,data=offset_pop)
lm.SSP585 <- lm(Lambda_slope~offset_SSP585,data=offset_pop)
lm.dist <- lm(Lambda_slope~offset_climate,data=offset_pop)

lm.1215_10 <- lm(Lambda_slope~offset_1215,data=offset_pop_10)
lm.SSP245_10 <- lm(Lambda_slope~offset_SSP245,data=offset_pop_10)
lm.SSP585_10 <- lm(Lambda_slope~offset_SSP585,data=offset_pop_10)
lm.dist_10 <- lm(Lambda_slope~offset_climate,data=offset_pop_10)
...
#By region
ggplot(offset_pop,aes(x=offset_1215, y=Lambda_slope, color=Region,label=Demo_ID))+
...
#2012-2015 offset plotted against lambda
ggplot(offset_pop, aes(x=offset_1215, y=Lambda_slope, label=Demo_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
...
ggplot(offset_pop, aes(x=offset_SSP245, y=Lambda_slope, label=Demo_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
ggplot(offset_pop, aes(x=offset_SSP585, y=Lambda_slope, label=Demo_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
ggplot(offset_pop, aes(x=offset_climate, y=Lambda_slope, label=Demo_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
ggplot(offset_pop_10, aes(x=offset_1215, y=Lambda_slope, label=Paper_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
#SSP 245 offset plotted against lambda
ggplot(offset_pop_10, aes(x=offset_SSP245, y=Lambda_slope, label=Paper_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
#SSP 585 offset plotted against lambda
ggplot(offset_pop_10, aes(x=offset_SSP585, y=Lambda_slope, label=Paper_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
#climate distance plotted against lambda
ggplot(offset_pop_10, aes(x=offset_climate, y=Lambda_slope, label=Paper_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
