...
offset_pop <- offset_pop %>% filter(Paper_ID!<13)
...
#SSP 245 offset plotted against lambda
ggplot(offset_pop, aes(x=offset_SSP245, y=Lambda_slope, label=Paper_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
...
#SSP 585 offset plotted against lambda
ggplot(offset_pop, aes(x=offset_SSP585, y=Lambda_slope, label=Paper_ID)) + 
  geom_point(aes(color=Region), size =4.5)+
  geom_smooth(method=lm,color="black")+
  #  geom_label_repel(aes(label = ID))+
  geom_text(hjust=-.15, vjust=-.2)+
