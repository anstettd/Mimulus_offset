...
wza_empri_mat
ggsave("Graphs/wza_empri_mat.png", wza_empri_mat, width=10, height = 5, units = "in")
...
wza_empri_map
ggsave("Graphs/wza_empri_map.png", wza_empri_map, width=10, height = 5, units = "in")
...
wza_empri_cmd
ggsave("Graphs/wza_empri_cmd.png", wza_empri_cmd, width=10, height = 5, units = "in")
